...
from app.services.v3.search_service import SearchServiceV3
...
class RankServiceV3:
    ...
    def __init__(self):
        self.search_service = SearchServiceV3()
    ...
    def get_ranked_portfolios(self, req: RankDTOV3.GetRankPtfoRequest) -> RankDTOV3.GetRankPtfoResponse:
        ...
        Args:
            req (RankDTOV3.GetRankPtfoRequest): 사용자의 요청 데이터

        Returns:
            RankDTOV3.GetRankPtfoResponse: factor (desc, what, how, style) 및 랭킹 결과
        """
    ...
    def get_ranked_portfolios_by_ad_elements(self, req: RankDTOV3.GetRankPtfoByAdElementsRequest) -> RankDTOV3.GetRankPtfoResponse:
        """
        이미 추출된 광고 요소(ad_elements)를 기반으로 유사도 검사를 수행하고
        관련된 포트폴리오를 랭킹 순서로 반환합니다.

        Args:
            req (RankDTOV3.GetRankPtfoByAdElementsRequest): 광고 요소 및 diversity 옵션이 포함된 요청 객체

        Returns:
            RankDTOV3.GetRankPtfoResponse: 생성된 광고 요소와 랭킹된 포트폴리오 리스트
        """
    ...
    def _rank_with_ad_elements(
        ...
        Args:
            ad_element_resp (RankDTOV3.AdElementResponse): 광고 요소 정보 (desc, what, how, style)
            diversity (int): 검색 결과 다양성 조정 값

        Returns:
            RankDTOV3.GetRankPtfoResponse: 광고 요소와 해당 요소 기반의 포트폴리오 랭킹 결과
        """
